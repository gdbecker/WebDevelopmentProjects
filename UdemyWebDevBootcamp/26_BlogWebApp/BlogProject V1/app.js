...
app.get("/posts/:postTitle", function(req, res) {
  var selectedBlog = {};
  if (blogPosts.some(e => lodash.kebabCase(e.title) == lodash.kebabCase(req.params.postTitle))) {
    console.log("Match found!");
  };

  blogPosts.forEach(function(blog) {
    if (lodash.kebabCase(blog["title"]) == lodash.kebabCase(req.params.postTitle)) {
      selectedBlog = blog;
    };
  });
